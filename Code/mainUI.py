...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cBox_TrainModel.setItemText(4, _translate("MainWindow", "CNN_LSTM_Single"))
        self.cBox_TrainModel.setItemText(5, _translate("MainWindow", "CNN_LSTM_Multi"))
        self.cBox_TrainModel.setItemText(6, _translate("MainWindow", "CNN_LSTM_Bidirectional"))
        self.cBox_TrainModel.setItemText(7, _translate("MainWindow", "CNN_LSTM_Dropout"))
        self.cBox_TrainModel.setItemText(8, _translate("MainWindow", "CNN_LSTM_Attention"))
        self.cBox_TrainModel.setItemText(9, _translate("MainWindow", "GRU"))
